...
#define MQTT_HOST IPAddress(192, 168, 88, 21)
...
unsigned long INFOpreviousMillis = 1500;
unsigned long DATEpreviousMillis = 3599000;
unsigned long TIMEpreviousMillis = 0;
unsigned long WIFIpreviousMillis = 0;
unsigned long MQTTpreviousMillis = 240000;  //valore dipartenza 1 min prima del refresh
unsigned long DISPLAYpreviousMillis = 0;
*/

int INFOinterval = 2000;     //  DHT refresh interval   2s
int DATEinterval = 5000;     //  DATE refresh interval  1h
int TIMEinterval = 1000;     //  refresh interval       1s
int WIFiinterval = 10000;    //  WiFi refresh interval  10s
int MQTTinterval = 60000;    //  MQTT refresh interval  5min
...
void setup() {
  ...
  timer.every(INFOinterval, showInfo);      // Alternare con Date
  timer.every(DATEinterval, showDate);      // Alternare con Info
